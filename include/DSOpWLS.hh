...
public: // Without description
  ...
  DSOpWLS(const G4String& processName = "OpWLS",
...
inline
G4bool DSOpWLS::IsApplicable(const G4ParticleDefinition& aParticleType)
{
   return ( &aParticleType == G4OpticalPhoton::OpticalPhoton() );
}

inline
G4PhysicsTable* DSOpWLS::GetIntegralTable() const
{
  return theIntegralTable;
}

inline
void DSOpWLS::DumpPhysicsTable() const
{
