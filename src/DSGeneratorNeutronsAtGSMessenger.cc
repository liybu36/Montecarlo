...
(DSGeneratorNeutronsAtGS *fPtclGun) {
  ...
  // height of source
  heightCmd = new 
    G4UIcmdWithADoubleAndUnit("/ds/generator/neutrons/height",this);
  ...
  // radius of source
  radiusCmd = new 
    G4UIcmdWithADoubleAndUnit("/ds/generator/neutrons/radius",this);
...
void DSGeneratorNeutronsAtGSMessenger::SetNewValue(G4UIcommand *command, 
						       G4String newValues) 
{
