...
//
//
// $Id: G4ParticleDefinition.cc,v 1.1 2014/05/21 13:43:00 dfranco Exp $
//
// 
// --------------------------------------------------------------
...
G4double G4ParticleDefinition::GetIonLifeTime() const
{
  ...
  // DF: 
  // In the original file, the next line is commented and the following 3 lines should be uncommented.
  // This modification is needed in order to have the possibility to set to 0 the lifetime of the 
  // ions. 
